(deftheme first-theme
  "Created 2025-09-12.")

(custom-theme-set-faces
 'first-theme
 '(default ((t (:family "Adwaita Mono" :foundry "UKWN" :width normal :height 113 :weight regular :slant normal :underline nil :overline nil :extend nil :strike-through nil :box nil :inverse-video nil :foreground "#bbc2cf" :background "#282c34" :stipple nil :inherit nil))))
